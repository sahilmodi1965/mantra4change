...
- On every `mantra4change-write` and `mantra4change-feedback` invocation (catches issues before they hit a commit).
...
## Output format
```
LINT — Mantra4Change brain — YYYY-MM-DD HH:MM UTC
