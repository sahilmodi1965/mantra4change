# ARCHITECTURE — Mantra4Change brain
...
What the brain knows about Mantra4Change. Typed, frontmatter-contracted, `_status:`-tracked. Read by every session as context, via the index (never globbed).
...
| **concepts** | `wiki/concepts/<kebab>.md` | One file per idea, framework, claim, or recurring theme. | TL;DR (≤80w) / Why it matters for Mantra4Change / Supporting sources / Related concepts / Contradictions. |
