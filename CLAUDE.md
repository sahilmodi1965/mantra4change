...
- **Daily** — Pratik drops content and runs Claude Code sessions for output. $20 plan economics: keep sessions focused; defer heavy ops to maintainer accounts.
...
1. **Start** — read `INTENT.md` and `ARCHITECTURE.md` once. Read `state/` files lazily — only the ones touching what Pratik asked.
