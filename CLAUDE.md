...
- **Daily user:** Pratik Jain (pratik.jain@mantra4change.com)
...
### 3. Tone — succinct by default (binding for all replies to Pratik)
...
- **Pratik's name used once at start, once at end.** Not every turn.
...
**Wrap.** Then surface a tight summary to Pratik, split into **Review** (passive — scan + push back if off) and **Do** (active — on Pratik). Hard cap: **3 items per column.** No more.
...
👉 https://sahilmodi1965.github.io/mantra4change/  (refreshes in ~60s)
```
